...
const menusPath = "blogSite/config/_default/menus.en.toml";
const languagesPath = "blogSite/config/_default/languages.toml";
const hugoConfigPath = "blogSite/hugo.toml";
const developmentDir = "blogSite/config/development";
const i18nDir = "blogSite/i18n";
const englishContentDir = "blogSite/content/english";
const targetContentDir = "blogSite/content";
...
const removeMultilang = () => {
  ...
  // 6. Move all folders and files from blogSite/content/english to blogSite/content
