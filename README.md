...
We built this custom script to make your project setup easier. It will create a new Hugo theme folder and clone the Hugoplate theme into it. Then move the blogSite folder into the root directory. So that you can start your Hugo server without going into the blogSite folder. Use the following command to setup your project.
